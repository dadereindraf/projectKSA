...
<head>
    <meta charset="utf-8" />
    <title>Jatuh Tempo 15 Hari</title>
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                if (mysqli_num_rows($result) > 0) {
                                                    ...
                                                    echo "<div class='alert alert-warning text-center' role='alert'>Tidak ada data jatuh tempo dalam 15 hari yang ditemukan.</div>";
                                                }
                                                        ...
                                                        if ($hasRecipient) {
                                                            ...
                                                            $mail->Body = "
                                                                            ...
                                                                            <p>
                                                                                ...
                                                                                akan berakhir pada tanggal <strong>$tanggalAkhir</strong> atau 15 hari lagi. Jika tidak ada Tindak Lanjut dalam 5 hari kalender, akan dilakukan freeze pada proses kerjasama.
                                                                            </p>
                                                                            <p>
                                                                                Apabila terdapat resiko atas keterlambatan proses pembahasan maupun perpanjangan PKS, resiko sepenuhnya akan ditanggung oleh PIC. Jika ada pertanyaan lebih lanjut mengenai hal ini, dapat menghubungi tim tata kelola
                                                                            </p>
                                                                            <p>
    ...
    <script>
        function openWhatsApp(phoneNumber, nomorPks, ruangLingkup, tanggalAkhir) {
            ...
            var message = encodeURIComponent(
                ...
                "Dengan hormat" + ",\n\n" +
                "Masa berlaku kerjasama PKS dengan *" + nomorPks + "* tentang *" + ruangLingkup + "* akan berakhir pada tanggal *" + tanggalAkhir + "* atau 15 hari lagi. Jika tidak ada Tindak Lanjut dalam 5 hari kalender, akan dilakukan freeze pada proses kerjasama.\n\n" +
                "Apabila terdapat resiko atas keterlambatan proses pembahasan maupun perpanjangan PKS, resiko sepenuhnya akan ditanggung oleh PIC. Jika ada pertanyaan lebih lanjut mengenai hal ini, dapat menghubungi tim tata kelola\n\n" +
                "Terima kasih atas perhatian dan kerjasamanya\n\n" +
                "Hormat kami,\n\n\n" +
                "*Tim Tata Kelola*"
